...
from FlrBots.data import FLIER
...
API_ID = 17792911
API_HASH = "2e6e8f5c5b72295c90f37bc18cc92a55"
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", default="6101630256").split()))
for x in FLIER:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("OWNER_ID", default="6101630256"))
